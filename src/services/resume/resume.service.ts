...
export const previewResumeService = async (userId: number, publicId: string) => {
    ...
    const renderData = {
        ...
        candidate_education: (resume.resume_education || []).map((e: any) => ({
            ...
            startMonth: e.startMonth || (e.startDate ? String(new Date(e.startDate).getMonth() + 1).padStart(2, "0") : ""),
            startYear: e.startYear || (e.startDate ? String(new Date(e.startDate).getFullYear()) : ""),
            endMonth: e.endMonth || (e.endDate ? String(new Date(e.endDate).getMonth() + 1).padStart(2, "0") : ""),
            endYear: e.endYear || (e.endDate ? String(new Date(e.endDate).getFullYear()) : ""),
